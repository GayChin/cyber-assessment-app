...
import SingleActivityBanner from "../SingleActivityBanner/SingleActivityBanner";
...
const dummyActivities = {
  ...
  duration_length: 30,
  learning_outcomes: ["Point A", "Point B"],
};

const DummySingleActivity = (dummyActivities) => {
  return (
    <>
      {/* <SingleActivityBanner activity={dummyActivities} /> */}
...
export default DummySingleActivity;
